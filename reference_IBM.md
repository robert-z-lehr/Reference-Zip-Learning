...
| Problem Categories         | Algorithms                               | Relevant Terminology/Jargon          | Resources                                                                                                       | Practice Examples                                                                  |
|----------------------------|------------------------------------------|--------------------------------------|------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| Classification             | Logistic Regression<br>Decision Trees    | Label, Class, Target Variable<br>Node, Leaf, Branch        | [Resource 1](#)<br>[Resource 2](#)<br>[Resource 3](#)                               | Email Spam Filter<br>Credit Scoring                                               |
